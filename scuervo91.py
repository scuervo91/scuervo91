...
python_tree.add(":star2:[link=https://github.com/scuervo91/reservoirpy]Reservoirpy")
...
python_tree.add(":fire:[link=https://github.com/scuervo91/pvtpy]pvtpy (On Dev)")
python_tree.add(":fire:[link=https://github.com/scuervo91/pvtpy]wellproductivitypy (On Dev)")
